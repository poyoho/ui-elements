(function () {
    ...
    var localize$2 = main.loadMessageBundle();
        ...
        switch (state) {
          ...
          case ScannerState.AfterOpeningEndTag:
            ...
            if (stream.skipWhitespace()) {
              return finishToken(offset, TokenType.Whitespace, localize$2("error.unexpectedWhitespace", "Tag name must directly follow the open bracket."));
            }
            state = ScannerState.WithinEndTag;
            stream.advanceUntilChar(_RAN);
            if (offset < stream.pos()) {
              return finishToken(offset, TokenType.Unknown, localize$2("error.endTagNameExpected", "End tag name expected."));
            }
            return internalScan();
          case ScannerState.WithinEndTag:
            ...
            if (emitPseudoCloseTags && stream.peekChar() === _LAN) {
              state = ScannerState.WithinContent;
              return finishToken(offset, TokenType.EndTagClose, localize$2("error.closingBracketMissing", "Closing bracket missing."));
            }
            errorMessage = localize$2("error.closingBracketExpected", "Closing bracket expected.");
            break;
          case ScannerState.AfterOpeningStartTag:
            ...
            stream.advanceUntilChar(_RAN);
            if (offset < stream.pos()) {
              return finishToken(offset, TokenType.Unknown, localize$2("error.startTagNameExpected", "Start tag name expected."));
            }
            return internalScan();
          case ScannerState.WithinTag:
            ...
            if (emitPseudoCloseTags && stream.peekChar() === _LAN) {
              state = ScannerState.WithinContent;
              return finishToken(offset, TokenType.StartTagClose, localize$2("error.closingBracketMissing", "Closing bracket missing."));
            }
            stream.advance(1);
            return finishToken(offset, TokenType.Unknown, localize$2("error.unexpectedCharacterInTag", "Unexpected character in tag."));
    ...
    var localize$1 = main.loadMessageBundle();
            ...
            for (var entity in entities) {
              if (endsWith(entity, ";")) {
                ...
                result.items.push({
                  ...
                  documentation: localize$1("entity.propose", "Character entity representing '" + entities[entity] + "'"),
